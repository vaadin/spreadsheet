        ...
        if (oldFormat != null) {
            try {
                ...
                LOGGER.log(Level.FINEST,
                        "Could not parse String to format, "
                                + oldFormat.getClass() + ", "
                ...
                if (cell.getCellType() == CellType.FORMULA) {
                    if (sentFormulaCells.contains(key)
                        ...
                        if (cd == null) {
                            ...
                            // null or empty; this case is probably quite rare,
                            // formula cell pointing to a cell that was removed
                            // or had its value cleared ???
                            cd = new CellData();
