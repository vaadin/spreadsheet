...
public class CustomFormattingIT extends AbstractSpreadsheetTestCase {
    ...
    @Before
    public void init() {
        headerPage.loadFile("custom_formatting_rainbow.xlsx", this);
    }
    ...
    private SpreadsheetElement getSpreadsheet() {
