...
public class Spreadsheet extends Component implements HasComponents, HasSize, HasStyle,
    ...
    public void setColGroupingData(List<GroupingData> colGroupingData) {
        ...
        getElement().setProperty("colGroupingData", Serializer.toJson(colGroupingData));
    }

    public void setRowGroupingData(List<GroupingData> rowGroupingData) {
        this.rowGroupingData = rowGroupingData;
        getElement().setProperty("rowGroupingData", Serializer.toJson(rowGroupingData));
    }
...
//                }
    ...
    private void registerCustomComponent(PopupButton component) {
        ...
        getElement().setProperty("popupbuttons", Serializer.toJson(popupButtonStates));
    }
